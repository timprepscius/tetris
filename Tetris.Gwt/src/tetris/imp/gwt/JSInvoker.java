...
public class JSInvoker implements Exportable
{
	...
	static JavaScriptObject invokeR (Object oo, String f) throws RuntimeException
	{
		return invokeR (oo, f, new Object[0]);
	}
	
	static JavaScriptObject invokeR (Object oo, String f, Object...p) throws RuntimeException
	{
		try
		{
			return invoke(oo, f, p);
		}
